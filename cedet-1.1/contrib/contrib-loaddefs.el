...
(ede-add-project-autoload (ede-project-autoload "edegnustep" :name "GNUstep-Make" :file (quote ede-gnustep) :proj-file "ProjStep.ede" :load-type (quote ede-step-load) :class-sym (quote ede-step-project)))

(ede-add-project-autoload (ede-project-autoload "gnustep-root" :name "GNUstep-make Top Most" :file (quote ede-gnustep) :proj-file "RootProjStep.ede" :initializers (quote (:project-mode scanner)) :load-type (quote ede-gnustep-load) :class-sym (quote ede-step-project)))

(ede-add-project-autoload (ede-project-autoload "gnustep" :name "GNUstep-Make in scanner mode" :file (quote ede-gnustep) :proj-file "ProjStep.ede" :initializers (quote (:project-mode scanner)) :load-type (quote ede-gnustep-load) :class-sym (quote ede-step-project)))
...
;;;;;;  "wisent-ruby-wy.el" "wisent-ruby.el") (20836 3271 666567))
